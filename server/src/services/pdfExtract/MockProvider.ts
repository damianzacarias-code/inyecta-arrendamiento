...
const MOCK_DATA: Record<TipoExtract, Record<string, unknown>> = {
  ...
  ESTADO_CUENTA: {
    ...
    saldoInicial: 85000.5,
    saldoFinal: 152300.75,
    totalDepositos: 250000,
    totalRetiros: 182699.75,
  },
  TABLA_AMORTIZACION: {
    emisor: 'Inyecta Arrendamiento',
    cliente: 'Juan Pérez García',
    plazoMeses: 48,
    montoFinanciado: 1917662.07,
    rentaMensual: 75896.8,
    rentaConIVA: 88040.29,
    tasaAnual: 0.36,
    valorResidual: 0,
    fechaPrimerPago: '2026-07-01',
    fechaUltimoPago: '2030-06-01',
    totalPagar: 4225933.92,
  },
  CARATULA: {
    folioContrato: 'ARR-001-2026',
    arrendador: 'FSMP Soluciones de Capital SA de CV SOFOM ENR',
    arrendatario: 'Juan Pérez García',
    rfcArrendatario: 'PEGJ800101AB1',
    producto: 'FINANCIERO',
    plazoMeses: 48,
    rentaMensual: 75896.8,
    valorBien: 2100000,
    depositoGarantia: 0,
    comisionApertura: 95883.1,
    fechaFirma: '2026-06-01',
    bienDescripcion: 'Camioneta pickup Toyota Hilux SR doble cabina 4x4',
  },
  CFDI_RENTA: {
    emisor: 'FSMP Soluciones de Capital SA de CV SOFOM ENR',
    rfcEmisor: 'FSM190101AB1',
    receptor: 'Juan Pérez García',
    rfcReceptor: 'PEGJ800101AB1',
    folioFiscal: '12345678-ABCD-1234-ABCD-123456789012',
    serie: 'A',
    folio: '123',
    fecha: '2026-06-01',
    concepto: 'Renta mensual de arrendamiento — periodo junio 2026',
    subtotal: 75896.8,
    iva: 12143.49,
    total: 88040.29,
  },
